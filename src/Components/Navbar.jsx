...
//             <div className="absolute top-full left-0 right-0 bg-[#0f0f14] border border-white/[0.08] rounded-xl shadow-2xl overflow-hidden z-50">
//               <div className="py-1">
    ...
    >
      ...
      <div className="flex items-center gap-3 flex-shrink-0">
        ...
        <div
          className={`relative flex items-center gap-2
          bg-white/[0.04] border border-white/[0.08] rounded-lg
          px-3 py-1.5 w-56 focus-within:w-98 focus-within:border-green-500/40
          focus-within:bg-white/[0.07] transition-all duration-300`}
        >
          <span className="text-gray-600 text-xs">🔍</span>
          <input
